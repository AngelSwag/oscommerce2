...
define('TEXT_DATE_AVAILABLE', 'Set product as New to date:');
...
define('TEXT_PRODUCTS_DATE_AVAILABLE', 'Set product as New to date:');
...
define('TEXT_PRODUCTS_VIDEO', 'Products Youtube Video:<br><small>(<span style="color: red">NOTE!</span> enter only code, not full link. <br>For example, L9szn1QQfas etc.</small>)');
