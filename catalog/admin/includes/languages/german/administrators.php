...
define('HTPASSWD_INFO', '<strong>Zusätzlicher Schutz durch htaccess/htpasswd</strong><p>Dies osCommerce Online Merchant Administration Tool-Installation ist nicht mehr gesichert außen durch htaccess/htpasswd mittel.</p><p>Aktivierung der htaccess / htpasswd Security Layer speichert automatisch Administrator-Benutzernamen und das Kennwort in einer Datei htpasswd beim Update Administrator-Passwort. </p><p><strong>Hinweis</strong>,  diese zusätzliche Ebene der Sicherheit aktiviert ist, und Sie können nicht mehr auf die Administrations-Tool, können Sie die folgenden Änderungen und Kontakte auf der Website zu htaccess / htpasswd-Schutz zu aktivieren:</p><p><u><strong>1.  Bearbeiten Sie diese Datei:</strong></u><br /><br />' . DIR_FS_ADMIN . '.htaccess</p><p>Entfernen Sie die folgenden Zeilen, wenn sie vorhanden sind:</p><p><i>%s</i></p><p><u><strong>2. Löschen Sie diese Datei:</strong></u><br /><br />' . DIR_FS_ADMIN . '.htpasswd_oscommerce</p>') ;
define('HTPASSWD_SECURED', '<strong>Zusätzlicher Schutz durch htaccess/htpasswd</strong><p>Dies osCommerce Online Merchant Administration Tool Installation wird weiter durch htaccess / htpasswd Schutz gesichert.</p>'); 
