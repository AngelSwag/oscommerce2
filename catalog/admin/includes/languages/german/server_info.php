...
define('TEXT_EXPORT_INTRO', 'Die folgenden Informationen ist vorgesehen, um Gen osCommerce zu den Send-Button. Sie können auch die Daten in eine Datei, indem Sie auf die Schaltfläche Speichern geben. Diese Information ist völlig anonym und können nicht verwendet werden, um ein individuelles System zu identifizieren. Es wird verwendet, um zu unterstützen und Entwicklung Zwecken.');
define('TEXT_EXPORT_INFO', 'Exportieren Server Informationen');
