 ...
 */        
  function smartsuggest_install() {
    ...
    $x++;
    $this->default_config['SMARTSUGGEST_BOLD_SEARCH_LETTERS'] = array('DEFAULT' => 'true',
                'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES (NULL, 'Bold search letters', 'SMARTSUGGEST_BOLD_SEARCH_LETTERS', 'true', 'Bold the user entered search letters (&lt;b&gt;) in suggest results.', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')");
    $x++;
    $this->default_config['SMARTSUGGEST_SHOW_PRODUCT_IMAGE'] = array('DEFAULT' => 'true',
                'QUERY' => "INSERT INTO `".TABLE_CONFIGURATION."` VALUES (NULL, 'Show produt image', 'SMARTSUGGEST_SHOW_PRODUCT_IMAGE', 'true', 'When suggesting results moethod is choosen to be product, show the product image on the left on the result.', GROUP_INSERT_ID, ".$x.", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')");
    $x++;
