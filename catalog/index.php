...
<h1 class=""><?php echo $category['categories_name']; ?></h1>
...
if (isset($image['categories_image'])) {
	echo '<div class="subcategory_image">'.tep_image(DIR_WS_IMAGES . $image['categories_image'], $image['catname'], '','', '').'</div>';
}
?>
...
<?php
    ...
    if (PRODUCT_LIST_FILTER > 0) {
      ...
      if (tep_db_num_rows($filterlist_query) > 1) {
        ...
        echo '<div class="manufacturers_list">' . tep_draw_form('filter', tep_href_link(FILENAME_DEFAULT), 'get') . '<p class="t_right">' . TEXT_SHOW . '&nbsp;';
...
<?php
          ...
          if (BUYSHOP_SLIDER == 'simple') {
              include(DC_BLOCKS . 'megastore_flexslider_simple_'.BUYSHOP_THEME.'.php');
          } else {
              include(DC_BLOCKS . 'megastore_layerslider_'.BUYSHOP_THEME.'.php');
          }


          if (BUYSHOP_THEME == 'light') {
              include(DC_BLOCKS . 'megastore_slider_bestsellers.php');
              include(DC_BLOCKS . 'megastore_slider_specials.php');
              include(DC_BLOCKS . 'megastore_slider_newproducts.php');
          }


             include(DC_BLOCKS . 'megastore_expanded_footer_'.BUYSHOP_THEME.'.php');
